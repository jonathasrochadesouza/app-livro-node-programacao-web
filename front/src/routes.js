...
import CadastroUsuario from './paginas/InserirUsuario';
import SignInSide from './paginas/TesteUsuarios';
    ...
    return (
        <BrowserRouter>
            <Switch>
                ...
                <Route path = "/inserirUsuario" exact = {true} component = {CadastroUsuario}/>;
                <Route path = "/signup" exact = {true} component = {SignInSide}/>; 
            </Switch>
        </BrowserRouter>
    );
}
